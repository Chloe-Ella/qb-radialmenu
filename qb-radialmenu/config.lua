            ...
            items = {
                {
                    ...
                    icon = 'bell',
                    type = 'client',
                    event = 'police:client:10-13ASendPoliceEmergencyAlert',
                    shouldClose = true
                }, {
                    id = 'Emergencybutton',
                    title = '10-13B',
                    icon = 'bell',
                    type = 'client',
                    event = 'police:client:10-13BSendPoliceEmergencyAlert',
                    shouldClose = true
                }, {
                    id = 'Emergencybutton',
                    title = '10-99',
                    icon = 'bell',
                    type = 'client',
                    event = 'police:client:10-99SendPoliceEmergencyAlert',
                    shouldClose = true
                }        
            }
        }, {
...
Config.TrunkClasses = {
    ...
    [8] = {allowed = true, x = 0.0, y = -1.0, z = 0.25}, -- Motorcycles
