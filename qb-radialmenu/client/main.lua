...
local function IsPoliceOrEMSOrDoc()
    return (PlayerData.job.name == "police" or PlayerData.job.name == "doc" or PlayerData.job.name == "ambulance")
end
...
local function SetupRadialMenu() 
    FinalMenuItems = {} 
    if (IsDowned() and IsPoliceOrEMSOrDoc()) then 
            FinalMenuItems = { 
                [1] = { 
                    id = 'emergencybutton', 
                    title = "10-13a", 
                ...
                [3] = { 
                    ...
                    icon = 'circle-exclamation', 
                    type = 'client', 
                    event = 'police:client:SendPoliceEmergencyAlert3', 
                    shouldClose = true, 
...
RegisterCommand('radialmenu', function()
    if ((IsDowned() and IsPoliceOrEMSOrDoc()) or not IsDowned()) and not PlayerData.metadata["ishandcuffed"] and not IsPauseMenuActive() and not inRadialMenu then
